const appRedirectVerify = (intentUrl) => `
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Verificação de E-mail - RanGo</title>
    <style>
...
<body>
    <div class="card">
        <h2>Falta pouco!</h2>
        <p>Estamos redirecionando você para o aplicativo RanGo para validar sua conta.</p>
        ...
        <div id="desktop-warning" class="desktop-warning">
            ...
            Abra este e-mail no seu celular para verificar a conta diretamente pelo aplicativo.
        </div>
    </div>
    <script>
...
export default appRedirectVerify;
